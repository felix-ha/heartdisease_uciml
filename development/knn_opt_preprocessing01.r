...
# finding best k for kNN with forward selection, preprocessing data [0,1]
...
auc_best_model <- max(summary$Median)
print(paste("best k:", best_model, "auc:", round(auc_best_model,3)))
